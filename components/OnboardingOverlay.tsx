...
const LINES = [
  ...
  // 재설계(2026-07-22): 감방마다 표식·수가 지급되고, 셈법 낙서 3곳을 모아 각자 제 자리
  // 숫자만 계산할 수 있다 — 남의 몫은 물어봐야 한다. 그 구조를 여기서 한 줄로 깔아 둔다.
  "철문은 네 자리 번호로 잠겨 있다. 네 방의 표식이 네 몫의 숫자를 쥐고 있고, 셈법은 세 곳에 나뉘어 적혀 있다.",
  "네 몫은 너만 안다. 남의 몫은 물어라 — 혼자서는 문이 열리지 않는다.",
