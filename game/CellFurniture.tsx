  ...
  return (
    <group position={position} rotation={[0, rotationY, 0]}>
      ...
      {[-W / 2 + 0.04, W / 2 - 0.04].map((x, i) => (
        <mesh key={i} position={[x, topY / 2, 0]} castShadow>
...
export function Partition({
  ...
  return (
    <group position={position} rotation={[0, rotationY, 0]}>
      ...
      {/* 문쪽 끝 기둥 */}
      <mesh position={[0, height / 2, length / 2 - 0.05]} castShadow>
